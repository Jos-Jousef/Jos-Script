...
exports.run = async (client, message) => {
  ...
  let davet;
        if (message.channel.permissionsFor(this.client.user).has("827903376481452053")) {
            await channel.createInvite({temporary: false, maxAge: 0, maxUses: 0, unique: false}).then(i => { davet = i.url });
    ...
    var tavsiyeHook = new Discord.WebhookClient("827872853705228308", "iUaMBgZR-88eGdT0gpG0p-PW5RXKMq1_66i095hi2ck_dPUswK2KHrAipSVHWaSN8A7I")
